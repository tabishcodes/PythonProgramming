...
print(lin1.rindex("apple")) #finds the value and returns the pointer place else return error
print(lin1.rindex("banana", 5, 10)) #finds the value b/w specific range and returns the pointer place else return error
